...
MODEL_NAME_OR_PATH=/mnt/data/alanhshao/vita-e2e/outputs/lucy_deepseek-addExperts_s2p1
...
WEBQA_DIR="/mnt/data/hetinggao/manifest/spoken-web-questions/jsons/spoken-web-questions"
...
DATA_JSONS="$UNION60W_DIR/train.json $WEBQA_DIR/train.json"
EVAL_DATA_JSONS="$UNION60W_DIR/eval.json $WEBQA_DIR/eval.json"

#TASKS="AQACONVA RQACONVA RQACONV RQACONV RQACONV RQACONVA RQACONV RQACONVA"
TASKS="RQACONV RQACONV"
