...
MODEL_NAME_OR_PATH=/mnt/data/alanhshao/vita-e2e/outputs/vita_deepseek-chat_s1/checkpoint-16800
...
DATA_JSONS="$COMMON_DIR/train.json"
EVAL_DATA_JSONS="$COMMON_DIR/eval.json"
...
if [[ -z $DISTRIBUTED_ARGS ]]; then
	...
	#LAUNCH_CMD="deepspeed --include localhost:5 $TRAINING_SCRPT"
else
