...
MODEL_NAME_OR_PATH=/mnt/data/alanhshao/vita-e2e/outputs/bak0416/lucy_deepseek_adaptive_s2p2/checkpoint-7200
#/mnt/data/alanhshao/vita-e2e/outputs/lucy_deepseek-chat_s2p1
#/mnt/data/alanhshao/vita-e2e/outputs/lucy_qwen2moe-chat_s2p1/checkpoint-26800
...
databricks_dolly_15k="/mnt/data/alanhshao/vita-e2e/datasets/databricks-dolly-15k" #"/cfs/speech-data/text2text-chat/databricks/databricks-dolly-15k"
...
DATA_JSONS="$UNION60W_DIR/train.json $WEBQA_DIR/train.json $TriviaQA_DIR/train.json $atlas_math_sets/train.json $MathInstruct/train.json $camel_ai_math/train.json $databricks_dolly_15k/train.json"
EVAL_DATA_JSONS="$UNION60W_DIR/eval.json $WEBQA_DIR/eval.json $TriviaQA_DIR/eval.json $atlas_math_sets/eval.json $MathInstruct/eval.json $camel_ai_math/eval.json $databricks_dolly_15k/eval.json"

#TASKS="AQACONVA RQACONVA RQACONV RQACONV RQACONV RQACONVA RQACONV RQACONVA"
TASKS="RQACONV RQACONV RQACONV RQACONV RQACONV RQACONV RQACONV"
...
if [[ -z $DISTRIBUTED_ARGS ]]; then
	...
	#LAUNCH_CMD="deepspeed --include localhost:0,1,2,3 $TRAINING_SCRPT"
else
